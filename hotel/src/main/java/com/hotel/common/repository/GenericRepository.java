...
public abstract class GenericRepository<T> {
	...
	public void remove(final T entity, final Long id) throws PersistenceException {
	...
	public T refresh(final T entity, final Long id) {
		if (id == null) {
			return null;
		}
		return (T) getEntityManager().getReference(entity.getClass(), id);
	}
